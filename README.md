...
*	**Βαρύτητα ε:** Το μέγεθος της cache line size επηρεάζει το κόστος λιγότερο από όλα τα υπόλοιπα στοιχεία και για αυτό θα έχει ην αντίστοιχη βαρύτητα, η οποία θα είναι της τάξης του 5%.
...
Πηγες: Διαφάνειες του Μαθήματος "Αρχιτεκτονική Υπολογιστών" στο elearning, [https://www.gem5.org/], [https://www.spec.org/cpu2006/],  [https://www.extremetech.com/extreme/188776-how-l1-and-l2-cpu-caches-work-and-why-theyre-an-essential-part-of-modern-chips]
