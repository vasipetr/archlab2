...
### Βήμα 2
1.Μέσα από το αρχείο config.ini βλέπουμε τις default τιμές των παραμέτρων που ζητούμαστε να ελέγξουμε και να αλλάξουμε για τη μέγιστη επίδοση:
...
2. Στο αρχείο graphs2 έχουμε αποθηκεύσει γραφήματα που δείχνουν πως επηρεάζει η κάθε παράμετρος το CPI. Παρατηρούμε 
### Βήμα 3
...
![benchmark_cost](https://user-images.githubusercontent.com/73646657/146417397-91e2dc07-0fcc-42fb-8122-e64027b4a1e7.png)
